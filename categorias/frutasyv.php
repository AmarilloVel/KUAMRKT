...
<head>
    ...
    <title >KUAMRKT - Frutas y Verduras</title>
...
<body>
    ...
    <div> 
        <nav class="navbar navbar-expand-l navbar-dark bg-dark col-md-12">
                <div>
                    <a href="../index.php   " class="navbar-brand">KUAMRKT</a>                    
                </div>
                <div class="navbar-brand dropdown">
                    <button class="btn btn-default dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Categorias</button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item active" href="frutasyv.php">Frutas y Verduras</a>
                ...
                <a href="#" class="navbar-brand"><i class="fas fa-user fa-lg"></i></a>
                    ...
                    <a href="carritoCompras.html" class="navbar-brand">
    ...
    <div class="container-fluid" id="barSearchResults">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $.ajax({
                    url:'catbdd/get_prod_frutasyv.php',//cambiar a productos destacados
                    type:'POST',
                    data:{},
