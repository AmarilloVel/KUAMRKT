    ...
    <div> 
        <nav class="navbar navbar-expand-l navbar-dark bg-dark col-md-12">
                ...
                <div class="navbar-brand dropdown">
                    <button class="btn btn-default dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Categorias</button>
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item active" href="+cotas.php">Mascotas</a>
                ...
                <?php session_start(); if(isset($_SESSION['email'])):?>
                    <a href="cerrar.php" class="navbar-brand">Salir</a>
                    <a href="#" class="navbar-brand"> <i class="fas fa-sort"></i> Pedidos</i></a>
                <?php else:?>
                    <a href="login.php" class="navbar-brand"><i class="fas fa-user fa-lg"></i></a>
                <?php endif; ?>
                <?php if(isset($_SESSION['email'])): ?>
                    <a href="carrito.php" class="navbar-brand"><i class="fas fa-shopping-cart fa-lg"></i></a>
                <?php else:?>
                    <a href="login.php" class="navbar-brand"><i class="fas fa-shopping-cart fa-lg"></i></a>
                <?php endif; ?>
                </div>
        </nav>    
    </div>
    ...
    <div class="container-fluid" id="barSearchResults">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $.ajax({
                    url:'catbdd/get_prod_+cotas.php',//cambiar a productos destacados
                    type:'POST',
                    data:{},
